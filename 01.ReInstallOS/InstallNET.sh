...
[[ "$ddMode" == '1' ]] && {
  export SSL_SUPPORT='https://github.com/bmwcto/mygit/raw/master/01.ReInstallOS/wget_udeb_amd64.tar.gz';
  if [[ -n "$tmpURL" ]]; then
    DDURL="$tmpURL"
...
[[ -z "$myPASSWORD" ]] && myPASSWORD='$1$vfRGYEY4$rozyePMmWicgttev6Kdir1';
